...
box2.style.boxShadow = '0px 10px 36px rgba(0, 0, 0, 0.1), 0px 0px 0px 1px rgba(0, 0, 0, 0.06)';
...
moreElement.querySelectorAll("h5").forEach(h5 => h4.style.fontSize = "13px");
moreElement.querySelectorAll("h5").forEach(h5 => h4.style.color = "#999");
moreElement.querySelectorAll("h5").forEach(h5 => h4.style.display = "inline-block");
